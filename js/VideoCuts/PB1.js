class PB1 {
    ...
    tick(e) {
        ...
        for (var i = 0; i < window.zombieList.length; i++) {
            if (this.PB1.x > window.zombieList[i].zombie.x + 70 && this.PB1.x < window.zombieList[i].zombie.x + 166 && this.PB1.y > window.zombieList[i].zombie.y + 80 && this.PB1.y < window.zombieList[i].zombie.y + 100) {
                ...
                if (window.zombieList[i].blood == 0) {
                    ...
                    window.zombieList[i].zombie.addEventListener("animationend", this.animationend.bind(this, window.zombieList[i]))
                }
